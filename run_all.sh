...
python plots/plotter.py --csv_files plots/run-pretrain_rotation-tag-Loss_train.csv plots/run-pretrain_rotation-tag-Loss_val.csv plots/run-pretrain_jigsaw_puzzle-tag-Loss_train.csv plots/run-pretrain_jigsaw_puzzle-tag-Loss_val.csv plots/run-pretrain_contrastive_predictive_coding-tag-Loss_train.csv plots/run-pretrain_contrastive_predictive_coding-tag-Loss_val.csv plots/run-pretrain_moco-tag-Loss_train.csv plots/run-pretrain_moco-tag-Loss_val.csv  plots/run-pretrain_masked_patch_prediction-tag-Loss_train.csv plots/run-pretrain_masked_patch_prediction-tag-Loss_val.csv plots/run-pretrain_contrastive_mutliview_coding-tag-Loss_train.csv plots/run-pretrain_contrastive_mutliview_coding-tag-Loss_val.csv --name pretrain_loss --xlabel Epoch --ylabel Loss --labels Rotation_Training Rotation_Validation Jigsaw_Puzzle_Training Jigsaw_Puzzle_Validation CPC_Training CPC_Validation MOCO_Training MOCO_Validation MPP_train MPP_Validation CMC_train CMC_Validation
python plots/plotter.py --csv_files plots/run-downstream_none_ftl-tag-Accuracy_val.csv plots/run-downstream_rotation_ftl-tag-Accuracy_val.csv plots/run-downstream_jigsaw_puzzle_ftl-tag-Accuracy_val.csv plots/run-downstream_cpc_ftl-tag-Accuracy_val.csv plots/run-downstream_moco_ftl-tag-Accuracy_val.csv plots/run-downstream_cmc_ftl-tag-Accuracy_val.csv plots/run-downstream_patchprediction_ftl-tag-Accuracy_val.csv --name downstream_ftl_accuracy_val --xlabel Epoch --ylabel Accuracy_Validation --labels No_pretraining Rotation Jigsaw_Puzzle CPC MOCO CMC MPP
python plots/plotter.py --csv_files plots/run-downstream_none_e2e_whole_dataset-tag-Accuracy_val.csv plots/run-downstream_none_e2e-tag-Accuracy_val.csv plots/run-downstream_rotation_e2e-tag-Accuracy_val.csv plots/run-downstream_jigsaw_puzzle_e2e-tag-Accuracy_val.csv plots/run-downstream_cpc_e2e-tag-Accuracy_val.csv plots/run-downstream_moco_e2e-tag-Accuracy_val.csv plots/run-downstream_cmc_e2e-tag-Accuracy_val.csv plots/run-downstream_patchprediction_e2e-tag-Accuracy_val.csv --name downstream_e2e_accuracy_val --xlabel Epoch --ylabel Accuracy_Validation --labels No_pretraining_whole_dataset No_pretraining Rotation Jigsaw_Puzzle CPC MOCO CMC MPP
